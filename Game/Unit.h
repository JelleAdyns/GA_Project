...
public:
	...
	virtual void BeginOverlap(const std::unique_ptr<Projectile>& pProjectile) const = 0;
	virtual void EndOverlap(const std::unique_ptr<Projectile>& pProjectile) const = 0;
